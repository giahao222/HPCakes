...
namespace HPCakes.Areas.admin.Controllers
{
    public class productsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,categoryid,name,price,img,description,size,meta,hide,order,datebegin")] product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,categoryid,name,price,img,description,size,meta,hide,order,datebegin")] product product)
        {
            if (ModelState.IsValid)
            {
